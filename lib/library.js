...
/***/ function(module, exports, __webpack_require__) {
	...
	var _typoJs = __webpack_require__(55);
	...
	exports.default = {
	  ...
	  walkMatrix: function walkMatrix(matrix, positions, words) {
	    return _walkMatrix(matrix, positions, words);
	  },
	  // join together the x,y coordinates in the positions array to create a string
	  getWord: function getWord(matrix, positions) {
	    return _getWord(matrix, positions);
	  }
	};
	...
	function matrixIsValid(matrix) {
	  ...
	  if (matrix.length !== matrixSize) {
	    ...
	    try {
	      for (var _iterator3 = (0, _getIterator3.default)(matrix), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	...
	function _getWord(matrix, positions) {
	  var word = [];
	...
	function _walkMatrix(matrix, positions, words) {

	  // add the current word to the list
	  words.push(_getWord(matrix, positions));
	  ...
	  try {
	    for (var _iterator5 = (0, _getIterator3.default)(adjacents), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
	      ...
	      if (positionIsInBounds(newPosition) && positionIsNotUsed(newPosition, positions)) {
	        ...
	        _walkMatrix(matrix, newPositions, words);
	      }
	    }
	  } catch (err) {
