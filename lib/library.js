...
/***/ function(module, exports, __webpack_require__) {
	...
	var BoggLib = function () {
	  ...
	  (0, _createClass3.default)(BoggLib, [{
	    ...
	    value: function possibleWords() {
	      ...
	      this.matrix.forEach(function (row, rowIndex) {
	        row.forEach(function (column, colIndex) {
	          _this.walkMatrix([[rowIndex, colIndex]], possibleWords);
	        });
	      });
	    ...
	    key: 'scoringWords',
	    value: function scoringWords() {
	      var possibleWords = this.possibleWords();
	      var scoringWords = [];
	      ...
	      try {
	        for (var _iterator2 = (0, _getIterator3.default)(possibleWords), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	    ...
	    value: function walkMatrix(positions, words) {
	      ...
	      try {
	        for (var _iterator3 = (0, _getIterator3.default)(adjacents), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	    ...
	    value: function getWord(positions) {
	      ...
	      try {
	        for (var _iterator4 = (0, _getIterator3.default)(positions), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
